  ...
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-3xl items-center justify-center p-4">
      <section className="w-full rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
        <p className="text-xs font-medium uppercase tracking-wide text-zinc-500">Access Control</p>
        <h1 className="mt-2 text-2xl font-semibold text-zinc-900">You are not authorized</h1>
        <p className="mt-2 text-sm text-zinc-600">
          Your account does not have permission to access this page. If this is unexpected,
