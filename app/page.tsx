  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-50 p-4">
      <div className="w-full max-w-xl rounded-xl border border-zinc-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-zinc-600">Phase 2: authentication scaffold is ready.</p>
        ...
        <div className="mt-6 flex gap-3">
          ...
          <Link
            href="/register"
            className="rounded-md border border-zinc-300 px-4 py-2 font-medium text-zinc-900"
          >
            Register
          </Link>
        </div>
